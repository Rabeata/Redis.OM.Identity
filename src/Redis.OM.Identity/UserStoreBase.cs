...
using Redis.OM.Identity.Infrastructure.Helpers;
...
public abstract class UserStoreBase<TUser, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] TUserClaim, TUserLogin, TUserToken> :
...
public abstract class UserStoreBase<TUser, TRole, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] TUserClaim, TUserRole, TUserLogin, TUserToken, TRoleClaim> :
